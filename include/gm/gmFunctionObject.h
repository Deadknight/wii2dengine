...
public:
  ...
  */
  GM_INLINEWII int GetMaxStackSize() const { return m_maxStackSize; }

   /// \brief GetNumLocals
  GM_INLINEWII int GetNumLocals() const { return m_numLocals; }

  /// \brief GetNumParams
  GM_INLINEWII int GetNumParams() const { return m_numParams; }

  /// \brief GetNumParamsLocals()
  GM_INLINEWII int GetNumParamsLocals() const { return m_numParamsLocals; }

  /// \brief GetByteCode()
  GM_INLINEWII const void * GetByteCode() const { return m_byteCode; }

  /// \brief GetDebugName()
  GM_INLINEWII const char * GetDebugName() const;
  ...
  GM_INLINEWII const char * GetSymbol(int a_offset) const;
...
GM_INLINEWII const char * gmFunctionObject::GetDebugName() const
{
...
GM_INLINEWII const char * gmFunctionObject::GetSymbol(int a_offset) const
{

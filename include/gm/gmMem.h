...
template<class TYPE>
GM_INLINEWII TYPE* gmConstructElement(TYPE* a_element)
{
...
template<class TYPE>
GM_INLINEWII void gmDestructElement(TYPE* a_element)
{
  a_element->~TYPE();
}
...
template<class TYPE>
GM_INLINEWII void gmConstructElements(TYPE* a_elements, int a_count)
{
...
template<class TYPE>
GM_INLINEWII void gmDestructElements(TYPE* a_elements, int a_count)
{

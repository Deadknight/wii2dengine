...
public:
  ...
  GM_INLINEWII gmMemFixedSet();
  GM_INLINEWII ~gmMemFixedSet();

  /// \brief Alloc() an element
  /// \param a_size size of allocation
  GM_INLINEWII void* Alloc(int a_size);
...
protected:
  ...
  GM_INLINEWII SmallMemNode* GetSmallNodeData(void* a_ptr)  { return ((SmallMemNode*)a_ptr)-1; }
  GM_INLINEWII BigMemNode* GetBigNodeData(void* a_ptr)  { return ((BigMemNode*)a_ptr)-1; }

...
public:
  ...
  GM_INLINEWII const char* GetData() const { return m_stream; }
...
public:
  ...
  GM_INLINEWII void SetBlockSize(unsigned int a_blockSize) { m_stream.SetBlockSize(a_blockSize); }
  GM_INLINEWII const char* GetData() const { return m_stream.GetData(); }
  GM_INLINEWII char* GetUnsafeData() { return m_stream.GetData(); }
